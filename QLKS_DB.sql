...
INSERT [dbo].[CUSTOMER]([CUSTOMER_ID], [RENT_ID], [CUSTOMER_NAME], [TYPE_CUSTOMER], [ID_CARD], [ADDRESS]) VALUES (N'ND001',N'R001', N'Minh Tuyền', N'Nội địa',123456789,N'227 Nguyễn Văn Cừ, quận 5')
...
INSERT [dbo].[CUSTOMER]([CUSTOMER_ID], [RENT_ID], [CUSTOMER_NAME], [TYPE_CUSTOMER], [ID_CARD], [ADDRESS]) VALUES (N'ND003',N'R003', N'Thảo Nhi', N'Nội địa',123456789,N'227 Nguyễn Văn Cừ, quận 5')
INSERT [dbo].[CUSTOMER]([CUSTOMER_ID], [RENT_ID], [CUSTOMER_NAME], [TYPE_CUSTOMER], [ID_CARD], [ADDRESS]) VALUES (N'ND004',N'R004', N'Khắc Thuận', N'Nội địa',123456789,N'227 Nguyễn Văn Cừ, quận 5')
INSERT [dbo].[CUSTOMER]([CUSTOMER_ID], [RENT_ID], [CUSTOMER_NAME], [TYPE_CUSTOMER], [ID_CARD], [ADDRESS]) VALUES (N'ND005',N'R005', N'Vũ Khanh', N'Nội địa',123456789,N'227 Nguyễn Văn Cừ, quận 5')
INSERT [dbo].[CUSTOMER]([CUSTOMER_ID], [RENT_ID], [CUSTOMER_NAME], [TYPE_CUSTOMER], [ID_CARD], [ADDRESS]) VALUES (N'NN001',N'R006', N'Thu Tuyền', N'Nước ngoài',123456789,N'227 Nguyễn Văn Cừ, quận 5')
INSERT [dbo].[CUSTOMER]([CUSTOMER_ID], [RENT_ID], [CUSTOMER_NAME], [TYPE_CUSTOMER], [ID_CARD], [ADDRESS]) VALUES (N'NN002',N'R007', N'Hà Huỳnh', N'Nước ngoài',123456789,N'227 Nguyễn Văn Cừ, quận 5')
INSERT [dbo].[CUSTOMER]([CUSTOMER_ID], [RENT_ID], [CUSTOMER_NAME], [TYPE_CUSTOMER], [ID_CARD], [ADDRESS]) VALUES (N'NN003',N'R008', N'Thảo Quyên', N'Nước ngoài',123456789,N'227 Nguyễn Văn Cừ, quận 5')
INSERT [dbo].[CUSTOMER]([CUSTOMER_ID], [RENT_ID], [CUSTOMER_NAME], [TYPE_CUSTOMER], [ID_CARD], [ADDRESS]) VALUES (N'NN004',N'R009', N'Oanh Oanh', N'Nước ngoài',123456789,N'227 Nguyễn Văn Cừ, quận 5')
INSERT [dbo].[CUSTOMER]([CUSTOMER_ID], [RENT_ID], [CUSTOMER_NAME], [TYPE_CUSTOMER], [ID_CARD], [ADDRESS]) VALUES (N'NN005',N'R010', N'Nhựt Tường', N'Nước ngoài',123456789,N'227 Nguyễn Văn Cừ, quận 5')
